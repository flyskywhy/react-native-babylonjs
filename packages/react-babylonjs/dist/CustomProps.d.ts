...
export declare type AbstractMeshCustomProps = {
    /**
...
export declare type Control3DCustomProps = {
    /**
...
export declare type Control2DCustomProps = {
    /**
     * ???
     */
    gridColumn?: number;
...
export declare type VRExperienceHelperCustomProps = {
    enableInteractions?: boolean;
} & CustomProps;
/**
 * Custom Gizmo props used for declaratively attaching.
 */
export declare type GizmoCustomProps = {
    /**
 ...
 */
export declare type CameraCustomProps = {
    /**
 ...
 */
export declare type ADTCustomProps = {
    /**
 ...
 */
export declare type GlowLayerCustomProps = {
    /**
     * Adds all child nodes to the glow layer.
     */
    addIncludeOnlyChildren?: boolean;
};
export declare type VirtualKeyboardCustomProps = {
    /**
 ...
 */
export declare type AnyCustomProps = CustomProps & (AbstractMeshCustomProps & ADTCustomProps & CameraCustomProps & Control2DCustomProps & Control3DCustomProps & GizmoCustomProps & GlowLayerCustomProps & VirtualKeyboardCustomProps & ShadowGeneratorCustomProps & MaterialCustomProps);
